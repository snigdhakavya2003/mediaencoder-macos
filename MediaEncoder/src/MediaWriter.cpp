...
MediaWriter::MediaWriter(int width, int height, int videoNum, int videoDen, const std::string& videoCodec,
                         int videoBitrate, const std::string& audioCodec, int audioBitrate)
    : m_width(width), m_height(height), m_videoNumerator(videoNum), m_videoDenominator(videoDen),
      m_videoCodecName(videoCodec), m_videoBitrate(videoBitrate),
      m_audioCodecName(audioCodec), m_audioBitrate(audioBitrate), m_disposed(false) {
